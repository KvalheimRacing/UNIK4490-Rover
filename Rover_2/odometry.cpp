...
class PositionByOdometry{
    public:
            ...
            void odometry_calculations(rover2_motordriver::Velocity vel){
                ...
                velocity = (wheel_radius*(Wr-Wl))/2;

                // Calculating angular velocity with regards to world coordinates
                float ohmega = (wheel_radius*(Wr-Wl))/traversial_wheelbase;
...
int main(int argc, char **argv) {
    ...
    float traversial_wheelbase = 0,285 // distance between left and right side wheels
